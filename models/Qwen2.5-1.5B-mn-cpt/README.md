...
This model is a continual pretraining (CPT) checkpoint built by further pretraining Qwen2.5 1.5B on the Mongolian (Traditional Mongolian Script) portion of the [MC^2 Corpus](https://huggingface.co/datasets/pkupie/mc2_corpus).
