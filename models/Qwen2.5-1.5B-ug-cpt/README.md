...
---
# Qwen2.5-1.5B Continually Pretrained on Uyghur

This model is a continual pretraining (CPT) checkpoint built by further pretraining Qwen2.5 1.5B on the Uyghur portion of the [MC^2 Corpus](https://huggingface.co/datasets/pkupie/mc2_corpus).
...
* **Corpus:** Uyghur subset of MC^2 Corpus
* **Language:** Uyghur (`ug`)
